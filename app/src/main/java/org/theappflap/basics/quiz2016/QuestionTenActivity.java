...
public class QuestionTenActivity extends AppCompatActivity { //Change number here
    private RadioGroup group;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_question_ten); //CHANGE THIS NUMBER OH MY GOD OR YOUR LAYOUT WON'T LINK.
        ...
        ( findViewById( R.id.about_button )).setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick( View view ) {
                Intent intent = new Intent( QuestionTenActivity.this, AboutActivity.class ); //Change here.
                QuestionTenActivity.this.startActivity( intent );
            }
        } );
    ...
    private void addSkipper() {
        ...
        skipper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( QuestionTenActivity.this, FinalActivity.class); //Change here.
    ...
    class SubmitListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == R.id.submit_button) {
                if(pm.hasBeenAttempted(10) == true ) { //Make sure to up this number, lest the progress monitor fuck you.
                    //And whilst you're here, go to ProgressMonitor and up the total questions constant.
                    Toast.makeText( QuestionTenActivity.this, "Answer Already Attempted : Press SKIP", Toast.LENGTH_LONG).show(); //Change here.
                }
                else {
                    pm.recordAttempt(10); //Up this number too.
                    ...
                    if (number == -1) {
                        Toast.makeText(QuestionTenActivity.this, "You Must Select An Answer", Toast.LENGTH_LONG).show(); //Change here.
                        Log.d(MainActivity.DEBUG, "No Answer Selected");
                    } else {
                        if (number == R.id.answer_three) { //Change this to your right answer.
                            pm.setScore(1);
                            Toast.makeText(QuestionTenActivity.this, "thx for the help", Toast.LENGTH_LONG).show(); //Change here.
                            //Oh, and swap the text to what you want it to toast when they're right.
                            Log.d(MainActivity.DEBUG, " Correct Answer: ");
                        } else {
                            Toast.makeText(QuestionTenActivity.this, "LMAO no", Toast.LENGTH_LONG).show(); //Change here.
                            Log.d(MainActivity.DEBUG, " Incorrect Answer: ");
                        }
                        Intent intent = new Intent(QuestionTenActivity.this, FinalActivity.class); //Change here.
                        //Make sure the .class is right here too and in the last one.
                        QuestionTenActivity.this.startActivity(intent); //Change here.
                    }
                }
            }
            else {
